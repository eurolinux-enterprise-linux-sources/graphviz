# $Id: graphviz.spec.in,v 1.216 2009/10/27 19:49:50 ellson Exp $ $Revision: 1.216 $
...
Source0: http://www.graphviz.org/pub/graphviz/development/SOURCES/graphviz-2.26.0.tar.gz
...
%define SMYRNA 1
BuildRequires: gtkglarea2-devel gtkglext-devel freeglut-devel
%endif
%if %rhel >= 6
%define PHP 1
...
%define GDK_PIXBUF 1
%define PERL 1
BuildRequires: perl-devel perl-libs
%endif
%endif
...
BuildRequires: freeglut-devel gts-devel
%endif
%endif
...
%define GUILE 1
%define PYTHON 1
BuildRequires: libtool-ltdl libtool-ltdl-devel ruby ruby-devel guile-devel python python-devel
%endif
%if %fedora < 5
...
%define SMYRNA 1
BuildRequires: gtkglarea2-devel gtkglext-devel glade3-libgladeui-devel freeglut-devel
#define GLITZ 1
...
%define SFDP 1
%define LASI 1
BuildRequires: gd gd-devel perl-devel DevIL-devel lasi-devel
%endif
%if %att_fedora >= 8
%define R_LANG 1
BuildRequires: R-devel swig >= 1.3.33 perl-libs
